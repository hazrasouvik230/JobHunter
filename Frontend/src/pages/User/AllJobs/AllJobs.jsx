...
//       // setTotalPages(Math.ceil(response.data.jobs.length / limit));
//     } catch (error) {
//       console.log(error);
//     }
//   };
  ...
  return (
    <div className='px-6 md:px-32 py-12 pb-20 bg-gray-50'>
      ...
      {/* <div className='mb-2 text-gray-600'>
        Showing {filteredJobs.length === 0 ? 0 : startIndex + 1}-{Math.min(endIndex, filteredJobs.length)} of {filteredJobs.length} jobs
      </div> */}
