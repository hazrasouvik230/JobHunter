    ...
    <div className='px-6 md:px-32 py-12 bg-gray-50 min-h-screen'>
      <div className='text-center mb-8 mt-16 relative'>
        <div className="absolute left-0 top-0">
          <Link to="/" className="text-gray-600 hover:text-blue-800 hover:font-semibold transition-all">
            Back
          </Link>
        </div>

        <p className='text-4xl font-bold text-gray-900 mb-4'>Revenue Analytics</p>
