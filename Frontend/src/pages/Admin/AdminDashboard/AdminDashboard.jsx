...
//       try {
//         const token = localStorage.getItem("token");
//         const response = await axios.get("http://localhost:3000/api/admin/transactions", { headers: { Authorization: token } });
//         console.log(response.data.summary.totalRevenue);
//         setData(response.data.summary.totalRevenue);
//       } catch (error) {
//         console.log(error);
//       }
//     })();
...
//     const info = [
//         { label: "Enrolled users", icon: FaUsers, counts: users.length },
//         { label: "Enrolled companies", icon: PiBuildingsFill, counts: companies.length },
//         { label: "Revenue generated", icon: FaSackDollar, counts: data },
//     ];
...
const AdminDashboard = () => {
    ...
    return (
        <div className='px-6 md:px-32 py-12 pb-20 bg-gray-50 min-h-screen'>
            <div className='text-center mb-8 mt-16'>
                <div className="absolute left-6 md:left-32">
                ...
                <p className='text-4xl font-bold text-gray-900 mb-4'>Admin Dashboard</p>
