        ...
        <div className="border flex gap-4">
            <div className='bg-white border border-red-400 w-1/3 p-8 rounded-3xl shadow-xl'>
                ...
                <div className="border mt-4 flex items-center justify-center flex-col gap-6 py-10 rounded-2xl bg-red-300/50 border-red-600">
                    ...
                    <button className="bg-red-400 px-8 py-2 rounded-lg font-semibold text-white cursor-pointer hover:scale-105 hover:shadow-lg hover:shadow-red-300" onClick={() => handleRemove(fetchedUser._id)}>Remove User</button>
                </div>
            </div>
