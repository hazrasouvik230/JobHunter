...
//                 setRole("");
//             } else {
//                 // After successful login, mark as logged in and close modal
//                 props.setIsLoggedIn(true);
//                 props.handleClose();
//             }
//         }
...
//                             <p className="mb-1">Choose your role</p>
//                             <div className="flex items-center justify-between">
//                                 <div className={`border px-6 py-2 rounded flex items-center justify-center gap-2 cursor-pointer duration-300 ease-in-out ${role === "User" ? "bg-blue-100 border-blue-500 shadow-md scale-105" : "hover:bg-gray-300/50 hover:scale-105 hover:shadow-lg"}`} onClick={() => setRole("User")}>
//                                     <input type="radio" id="student" name="role" value="student" checked={role === "User"} onChange={() => setRole("User")} className="hidden" />
//                                     <label htmlFor="student" className="cursor-pointer">Become a Student</label>
//                                 </div>

//                                 <div className={`border px-6 py-2 rounded flex items-center justify-center gap-2 cursor-pointer duration-300 ease-in-out ${role === "HR" ? "bg-blue-100 border-blue-500 shadow-md scale-105" : "hover:bg-gray-300/50 hover:scale-105 hover:shadow-lg"}`} onClick={() => setRole("HR")}>
//                                     <input type="radio" id="employee" name="role" value="employee" checked={role === "HR"} onChange={() => setRole("HR")} className="hidden" />
//                                     <label htmlFor="employee" className="cursor-pointer">Become an Employee</label>
//                                 </div>
//                             </div>
//                             {errors.role && <p className="text-red-500 text-sm">Please select your role.</p>}
...
//                             <p className="mb-1">Choose your role</p>
//                             <div className="flex items-center justify-between">
//                                 <div className={`border px-6 py-2 rounded flex items-center justify-center gap-2 cursor-pointer duration-300 ease-in-out ${role === "User" ? "bg-blue-100 border-blue-500 shadow-md scale-105" : "hover:bg-gray-300/50 hover:scale-105 hover:shadow-lg"}`} onClick={() => setRoleLocal("User")}>
//                                     <input type="radio" id="student" name="role" value="User" checked={role === "User"} onChange={() => setRoleLocal("User")} className="hidden" />
//                                     <label htmlFor="student" className="cursor-pointer">Become a Student</label>
//                                 </div>

//                                 <div className={`border px-6 py-2 rounded flex items-center justify-center gap-2 cursor-pointer duration-300 ease-in-out ${role === "HR" ? "bg-blue-100 border-blue-500 shadow-md scale-105" : "hover:bg-gray-300/50 hover:scale-105 hover:shadow-lg"}`} onClick={() => setRoleLocal("HR")}>
//                                     <input type="radio" id="employee" name="role" value="HR" checked={role === "HR"} onChange={() => setRoleLocal("HR")} className="hidden" />
//                                     <label htmlFor="employee" className="cursor-pointer">Become an Employee</label>
//                                 </div>
//                             </div>
//                             {errors.role && <p className="text-red-500 text-sm">Please select your role.</p>}
...
//                                 <input type="text" name="companyName" id="companyName" className={`border w-full rounded p-2 required:border-red-500 ${errors.companyName ? 'outline-red-600' : 'outline-none'}`} value={companyName} onChange={(e) => setCompanyName(e.target.value)} />
...
//                                 <input type="file" name="companyLogo" id="companyLogo" accept="image/*" className={`border w-full rounded p-2 required:border-red-500 ${errors.companyLogo ? 'outline-red-600' : 'outline-none'}`} onChange={(e) => setCompanyLogo(e.target.files)} />
//                                 {
//                                     companyLogo && (
//                                         <div className="mt-2">
                        ...
                        <div className="mb-6">
                            <div className="mb-4">
                                ...
                                <input 
                                    ...
                                    name="companyName" 
                                    id="companyName" 
                                    className={`border w-full rounded p-2 ${errors.companyName ? 'outline-red-600' : 'outline-none'}`} 
                                    value={companyName} 
                            ...
                            <div className="mb-4">
                                ...
                                <input 
                                    ...
                                    id="companyLogo" 
                                    accept="image/*"
                                    className={`border w-full rounded p-2 ${errors.companyLogo ? 'outline-red-600' : 'outline-none'}`} 
